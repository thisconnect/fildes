...
var writeBuffer = (fd, buffer, offset, length, position) => {
  return new Promise((resolve, reject) => {
...
var writeData = (fd, data, position, encoding) => {
  return new Promise((resolve, reject) => {
...
var read = (fd, buffer, offset, length, position, encoding) => {
  return new Promise((resolve, reject) => {
    debug(
